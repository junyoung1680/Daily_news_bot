...
for display_category, search_keyword in categories.items():
    ...
    [작성 양식 및 규칙 - 절대 엄수]
    일반적인 별표(*) 마크다운은 절대 쓰지 마세요. 반드시 아래의 [T]와 [B] 태그만 사용하세요.
    섹션 이름(예: [대출])은 절대 출력하지 말고 바로 제목부터 시작하세요.

    [T]통찰력 있는 기사 제목 (발행일)[/T]
    ...
    [세부 지침]
    1. 제목: 반드시 [T] 와 [/T] 태그로 감싸세요.
    2. 강조: 본문에서 강조하고 싶은 주체(기업/기관)나 숫자는 반드시 [B] 와 [/B] 태그로 감싸세요. 조사는 태그 밖에 쓰세요. (예: [B]카카오뱅크[/B]는)
